...
def optimal_allocation_4_stocks(start_date, end_date, symbols):
  ...
  # O(4) notation for loop, which is never recommended for large data sets because of speed. But instructor recommended 
  # it for our this assignment because of the small data set.
  for i in range(0,11):
...
start_date = dt.datetime(2010,1,1) #Place any start date here
end_date = dt.datetime(2010,12,31) #Place any end date here
symbols = ['C', 'GS', 'IBM', 'HNZ']  #Place any 4 stock tickets here
